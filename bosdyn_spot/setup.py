...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'bosdyn_spot', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-bosdyn_spot',
    version=ABOUT['__version__'],
    description='The bosdyn_spot check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent bosdyn_spot check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Alisher A. Khassanov',
    author_email='alisher@merklebot.com',
    # License
    ...
    packages=['datadog_checks.bosdyn_spot'],
